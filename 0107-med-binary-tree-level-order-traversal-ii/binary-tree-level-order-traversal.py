...
class Solution(object):
    ...
    # and update the node list to the node children list. Repeat until the node list is empty. Reverse the list at the end (last element before reversal should be the first element)
    # to be presented.
